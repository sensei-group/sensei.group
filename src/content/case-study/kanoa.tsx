...
const kanoa: CaseStudyType = {
    ...
    full_description: [
        "Connected KANOA with top-tier partners for sustainable crowdfunding. Utilized Sensei's tech for analytics, e-commerce, and advertising. Emphasized programmatic advertising and human experience to lower CPAs. Developed impactful videos for KANOA. Leveraged influencers for credibility and reach.",
    ...
    strategy: [
        ...
        "Employed Sensei's analytics, e-commerce, and advertising technology.",

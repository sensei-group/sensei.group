...
const skully: CaseStudyType = {
    ...
    full_description: [
        "Created effective landing pages and crowdfunding campaigns, utilized Sensei's AI for targeted ads and email marketing, engaged audiences via dynamic content and social media, partnered with influencers, and developed high-impact videos for SKULLY AR-1",
        "Raised $5.8M via Indiegogo and Sensei, reached millions, increased website traffic by 30%, and positioned SKULLY AR-1 as a leading innovator in the motorcycle helmet industry while building a strong community of early adopters and brand advocates."
    ],
    ...
    strategy: [
        ...
        "Utilized Sensei's AI for targeted advertising and email marketing.",
    ...
    result: [
        "Raised $2.5M on Indiegogo and an additional $3.3M through Sensei.",

                ...
                element: (
                    <div className='p-6 pt-20 h-full w-full flex flex-col items-center justify-center text-center gap-[200px]'>
                        <div className='2xl:text-[52px] xl:text-4xl text-3xl font-light 2xl:leading-[64px] xl:leading-[48px] leading-10 text-center'>
                            Sensei.ai an <span className='font-bold'>AI-powered agency</span> and platform, has been instrumental in driving the growth and success of numerous high-profile projects across various industries. This case study compilation highlights Sensei's impactful work, showcasing the power of AI-driven strategies in achieving remarkable outcomes.
                        </div>

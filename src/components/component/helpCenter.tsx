      ...
      <main className="flex-1 px-4 py-8 sm:px-6 md:px-8 mt-[100px] bg-[#020712]">
        <div className="mx-auto max-w-4xl space-y-8">
          <div>
            ...
            <p className="text-gray-400">Get the support you need to make the most of Sensei.</p>
          </div>
            ...
            <div className="flex flex-col justify-between rounded-lg bg-black p-6 text-gray-300 mt-5 bg-background">
              ...
              <div className="mt-4">
                <Button
                  variant="outline"
                  onClick={() => {
                    window.location.href = "mailto:z@sensei.group?subject=Help Request&body=Dear Sensei Team,"
                  }}

      ...
      <main className="flex-1 px-4 py-8 sm:px-6 md:px-8">
        <div className="mx-auto max-w-4xl space-y-8">
          <div className="grid gap-6 max-w-6xl w-full mx-auto">
            <div>
              <h1 className="text-3xl font-bold">Building an AI App with Sensei</h1>
              <p className="text-gray-400">
                Creating an AI app using the Sensei platform involves several steps, from setting up your Sensei account
                to integrating various APIs and deploying your AI model. Below is a step-by-step guide to help you build
                an AI app using Sensei.
              </p>
            </div>
            <div className="grid gap-6 lg:grid-cols-3">
              <div className="relative group rounded-lg border border-gray-700 p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold tracking-tight">Step 1: Create Sensei Account</h3>
              ...
              <div className="relative group rounded-lg border border-gray-700 p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold tracking-tight">Step 7: Integrate with Sensei</h3>
                  <small className="text-sm leading-none text-gray-400">
              ...
              <div className="relative group rounded-lg border border-gray-700 p-4">
                ...
                <div className="flex-1">
                  ...
                  <small className="text-sm leading-none text-gray-400">
                    Use front-end framework, integrate Sensei APIs, communicate with AI model endpoint.
                  </small>
                </div>
              </div>
              <div className="relative group rounded-lg border border-gray-700 p-4">
              ...
              <ul className="list-disc list-inside text-gray-400">
                <li>
                  <Link href="#" className="underline hover:text-gray-200" prefetch={false}>
                    Sensei API Documentation
                  </Link>
                </li>
                <li>
                  <Link href="#" className="underline hover:text-gray-200" prefetch={false}>
                    Sensei Getting Started Guide
                  </Link>
                </li>
                <li>
                  <Link href="#" className="underline hover:text-gray-200" prefetch={false}>
                    Sensei Integrations Guide
                  </Link>
                </li>
              </ul>
              <p className="text-gray-400 mt-4">
                Following these steps, you can successfully create an AI-powered application using Sensei's powerful
                platform and APIs.
              </p>
            </div>
          </div>
